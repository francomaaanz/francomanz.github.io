...
gulp.task('less', function() {
  gulp.src( './dist/ui/less/main.less')
        .pipe(less())
        .pipe(gulp.dest('./dist/ui/less'))
        .pipe(livereload());
...
gulp.task('watch', function() {
  ...
  livereload.listen();
  gulp.watch('./dist/ui//myCss.css', ['css']);
  gulp.watch('./dist/ui/less/main.less', ['less']);
  gulp.watch('./dist/ui//myjs.css', ['scripts']);
...
gulp.task('default', ['less', 'css', 'scripts', 'copy-index-html', 'dev', 'watch']);
